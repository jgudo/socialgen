import { IAPIParams, IBookmark, IComment, IFetchParams, IMessage, INotification, IPost, IProfile, IRegister, IUser } from '~/types/types';
...
export const checkSession = () => httpRequest<IUser>({
  method: 'GET',
  url: '/check-session',
  headers: {
...
export const logout = () => httpRequest<{ success: boolean }>({ method: 'DELETE', url: '/logout' });

export const sendVerificationMail = () => httpRequest<{ success: boolean }>({
    method: 'POST',
    url: '/account/verify',
});

export const recoverPassword = (username: string) => httpRequest<{ success: boolean }>({
    method: 'POST',
    url: '/account/recover',
    data: { username }
});

export const resetPassword = (user_id: string, token: string, password: string) => httpRequest<{ success: boolean }>({
    method: 'PATCH',
    url: '/password/reset',
    data: { user_id, token, password }
});

export const getNewsFeed = (params: IAPIParams) => httpRequest<IPost[]>({
    method: 'GET',
    url: '/feed',
    params
})
...
export const getPosts = (username: string, params: IAPIParams) => {
...
export const getUser = (username: string) => httpRequest<IProfile>({ method: 'GET', url: `/${username}` })
