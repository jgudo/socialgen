          ...
          <TransitionGroup component={null}>
            <div>
              {notifications.map((notif) => notif.initiator && (
                ...
                >
                  <div
                    className={`border border-transparent dark:hover:border-indigo-700 ${notif.unread ? 'bg-indigo-100 dark:bg-indigo-1100 hover:bg-indigo-200' : 'bg-white dark:bg-indigo-1000 dark:hover:bg-indigo-1100'} p-4 hover:bg-gray-100 dark:hover:bg-indigo-1100 hover:opacity-95 divide-y divide-gray-100`}
                    key={notif.id}
                  ...
                  >
                    <div className="relative">
                      <div className="flex items-start">
                        <Avatar
                          url={typeof notif.initiator.profilePicture === 'string' ? notif.initiator.profilePicture : notif.initiator.profilePicture?.url}
