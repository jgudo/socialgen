...
import { AdminApiOptions, UploadApiResponse, v2 as cloudinaryV2 } from 'cloudinary';
...
export const uploadImageToStorage = (file: File | File[], folder: string): Promise<UploadApiResponse[] | UploadApiResponse> => {
    if (file) {
